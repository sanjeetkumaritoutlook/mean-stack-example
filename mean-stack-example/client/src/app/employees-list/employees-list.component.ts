...
@Component({
  ...
  template: `
    <p>Note: server is deployed on render, so there can be a delay of abt 50 s if you click Add button for registering new employee or loading the employee list</p>
